...
<div class="upload_buttons">
	<button
		class="btn btn-sm btn-primary shadow-none font-semibold text-white rounded-sm capitalize"
		on:click={handleUploadDirectories}
	>
